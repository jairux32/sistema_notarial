...
class PDFSplitter:
    def dividir_por_codigos(self, pdf_path, codigos, año, mes, tipo, numero_libro, base_output_dir, codigo_a_pagina=None, pdf_document=None):
        ...
        Si pdf_document se prove, lo reutiliza en vez de abrir uno nuevo.
        """
    ...
    def dividir_por_codigos_con_manual(self, pdf_path, codigos, codigos_manuales, año, mes, tipo, numero_libro, base_output_dir, pdf_document=None):
